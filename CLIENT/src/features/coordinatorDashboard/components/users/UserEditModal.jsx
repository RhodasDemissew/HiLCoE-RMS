    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-2 sm:px-4 py-4 sm:py-10">
      <div className="w-full max-w-lg rounded-2xl sm:rounded-3xl bg-white p-4 sm:p-6 lg:p-8 shadow-2xl mx-2 sm:mx-0">
        <div className="mb-4 sm:mb-6 flex items-center justify-between">
          <div>
            <h2 className="text-lg sm:text-xl font-semibold text-[color:var(--neutral-900)]">Edit Researcher</h2>
            <p className="text-xs sm:text-sm text-[color:var(--neutral-500)]">Adjust details before verification.</p>
          </div>
          <button
            type="button"
        ...
        <form className="space-y-3 sm:space-y-4" onSubmit={handleSubmit}>
          <div>
            <label className="block text-xs sm:text-sm font-semibold text-[color:var(--neutral-800)]" htmlFor="first_name_edit">
              First Name
            </label>
            <input
              id="first_name_edit"
          ...
          <div>
            <label className="block text-xs sm:text-sm font-semibold text-[color:var(--neutral-800)]" htmlFor="middle_name_edit">
              Middle Name
            </label>
            <input
              id="middle_name_edit"
          ...
          <div>
            <label className="block text-xs sm:text-sm font-semibold text-[color:var(--neutral-800)]" htmlFor="last_name_edit">
              Last Name
            </label>
            <input
              id="last_name_edit"
          ...
          <div>
            <label className="block text-xs sm:text-sm font-semibold text-[color:var(--neutral-800)]" htmlFor="student_id_edit">
              Researcher ID
            </label>
            <input
              id="student_id_edit"
          ...
          <div>
            <label className="block text-xs sm:text-sm font-semibold text-[color:var(--neutral-800)]" htmlFor="program_edit">
