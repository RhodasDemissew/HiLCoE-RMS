          ...
          <div className="flex min-h-full items-center justify-center px-4 py-10">
            <Transition.Child as={Fragment} enter="ease-out duration-200" enterFrom="opacity-0 scale-95" enterTo="opacity-100 scale-100" leave="ease-in duration-150" leaveFrom="opacity-100 scale-100" leaveTo="opacity-0 scale-95">
              <Dialog.Panel className="w-full max-w-2xl rounded-3xl bg-white p-8 shadow-2xl">
                ...
                <p className="mt-1 text-sm text-[color:var(--neutral-500)]">Update details for {formatFullName(supervisor)}.</p>

                <form className="mt-6 space-y-5" onSubmit={handleSubmit}>
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div>
                      <label className="block text-sm font-semibold text-[color:var(--neutral-800)]" htmlFor="edit-sup-first-name">
                        First Name
                      </label>
                      <input
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-[color:var(--neutral-800)]" htmlFor="edit-sup-middle-name">
                        Middle Name
                      </label>
                      <input
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-[color:var(--neutral-800)]" htmlFor="edit-sup-last-name">
                        Last Name
                      </label>
                      <input
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-[color:var(--neutral-800)]" htmlFor="edit-sup-id">
                        Supervisor ID
                      </label>
                      <input
                        id="edit-sup-id"
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-[color:var(--neutral-800)]">Specializations</label>
